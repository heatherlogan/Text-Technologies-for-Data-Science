...
- to run, enter 'python3 indexer.py' in command line.

- indexer.py will work on the file 'preprocessed.txt' produced by executing preprocess.py, and will place
 the indexed file named 'indexed.txt' in the current directory.
...
- search.py will take a txt file containing queries as argument, run on the previously outputted file named 'indexed.txt'.
